...
public class MovimientoController {
	   ...
	   @RequestMapping(value="/{id}", method=RequestMethod.GET)
		...
		@RequestMapping(value="/getRepProductosPrecioCantidadUnitario", method= RequestMethod.GET)
		...
		@RequestMapping(value="/getRepCategoriaProductosValor", method= RequestMethod.GET)
		public ResponseEntity<?>get(){
			return new ResponseEntity<List<Movimiento>>(movService.getRepCategoriaProductosValor(),HttpStatus.OK);
		}
